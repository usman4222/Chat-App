  ...
  return (
    <div>
      <div className=" relative">
        <div className="bg-[url('/src/assets/chat1.png')] bg-cover bg-no-repeat p-16">
              ...
              <div className='bg-white h-[100vh] rounded-xl'>
                <div>
                  <nav className='flex justify-between px-10 py-5 border-b '>
                    <div><IoChatbubbles className='text-[#FFA429] text-2xl' /></div>
                    <div><FaUserCircle className='text-[#FFA429] text-2xl' /></div>
                  </nav>
                  <main className='flex h-[600px] '>
                    <div className='pl-5 pr-5 border-r pt-2'>
                      <div>
                        <div className="relative">
